...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
	<div class="container">
		<a class="navbar-brand js-scroll-trigger" href="/miniproject"><img src="/miniproject/resources/img/logosample3.png" style="width:100px; height:48px"></a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="/miniproject/talk">Talk</a></li>
...
<!-- 			<li class="nav-item"><a class="nav-link js-scroll-trigger"
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					onclick='window.open("/miniproject/login","_blank","height=500,width=400, status=yes,toolbar=no,menubar=no,location=no");return false'> 
					<img src="/miniproject/resources/img/logout.png"
						style ="width:20px; height:20px" id="logoutImg"></a></li>
			</c:otherwise>
			</c:choose>
