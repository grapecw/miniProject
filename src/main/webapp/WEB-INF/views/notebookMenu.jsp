...
<div class="l-container">
  <div class="b-game-card" onclick="location.href='/miniproject/notebookSAMSUNG';">
    <div class="b-game-card__cover" style="background-image: url(/miniproject/resources/img/SAMSUNGLOGO2.png);" ></div>
  </div>
  <div class="b-game-card" onclick="location.href='/miniproject/notebookLG';">
    <div class="b-game-card__cover" style="background-image: url(/miniproject/resources/img/LGLOGO.png);"></div>
  </div>
  <div class="b-game-card" onclick="location.href='/miniproject/notebookAPPLE';">
    <div class="b-game-card__cover" style="background-image: url(/miniproject/resources/img/APPLELOGO.png);"></div>
  </div>
  <div class="b-game-card" onclick="location.href='/miniproject/notebookHANSUNG';">
    <div class="b-game-card__cover" style="background-image: url(/miniproject/resources/img/HANSUNGLOGO.png);"></div>
  </div>
  <div class="b-game-card" onclick="location.href='/miniproject/notebookMSI';">
    <div class="b-game-card__cover" style="background-image: url(/miniproject/resources/img/MSILOGO.png);"></div>
  </div>
  <div class="b-game-card" onclick="location.href='/miniproject/notebookASUS';">
    <div class="b-game-card__cover" style="background-image: url(/miniproject/resources/img/ASUSLOGO.jpg);"></div>
  </div>
  <div class="b-game-card" onclick="location.href='/miniproject/notebookLENOVO';">
