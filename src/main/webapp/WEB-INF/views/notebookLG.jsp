...
<div class="wrap">
	<div class="col-1-4">
    	<div class="show show-first">
      	<img src="/miniproject/resources/img/GRAM1.jpg" />
  	...
  	<div class="col-1-4">
    	<div class="show show-first">
      	<img src="/miniproject/resources/img/GRAM2.jpg"/>
      
	      <div class="mask">
        	<h2>LG Gram</h2>
        	<p class="price">LG Gram 14인치</p>
  	...
  	<div class="col-1-4">
    	<div class="show show-first">
      	<img src="/miniproject/resources/img/LG4.jpg"/>
      
	      <div class="mask">
        	<h2>LG 울트라기어</h2>
        	<p class="price">LG 울트라기어 17인치</p>
        	<a href="#" class="more">More info</a>
      	</div>
    	</div>
  	</div>
  	...
  	<div class="col-1-4">
    	<div class="show show-first">
      	<img src="/miniproject/resources/img/LG3.jpg"/>
      
	      <div class="mask">
        	<h2>LG 울트라기어</h2>
        	<p class="price">LG 울트라기어 15인치</p>
        	<a href="#" class="more">More info</a>
      	</div>
    	</div>
  	</div>
  	...
  	<div class="col-1-4">
    	<div class="show show-first">
      	<img src="/miniproject/resources/img/LG6.jpg"/>
      
	      <div class="mask">
        	<h2>LG 울트라PC</h2>
        	<p class="price">LG 울트라PC 17인치</p>
        	<a href="#" class="more">More info</a>
      	</div>
    	</div>
  	</div>
  	...
  	<div class="col-1-4">
    	<div class="show show-first">
      	<img src="/miniproject/resources/img/LG5.jpg"/>
      
	      <div class="mask">
        	<h2>LG 울트라PC</h2>
        	<p class="price">LG 울트라PC 15인치</p>
        	<a href="#" class="more">More info</a>
      	</div>
    	</div>
  	</div>
