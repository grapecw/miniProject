...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/lightbox.css" rel="stylesheet" />
<style>
.prodimg {
	transform: scale(1);
...
<body id="page-top" class = "bg-img">
 ...
 <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#signup"> <img src="/miniproject/resources/img/logout.png" width="20px" height="20px"></a>
          </li>
    ...
    <article style = "text-align: center; vertical-align: middle; width: 80%; margin:auto; color : black">
    	<div id ="imgarea" >
    	<a href="/test/resources/img/1.png" data-lightbox="image-1" data-title="My caption"><img class="prodimg" src = "/test/resources/img/1.png" style = "width:20%"></a>
    	<a href="/test/resources/img/1.png" data-lightbox="image-1" data-title="My caption"><img class="prodimg" src = "/test/resources/img/1.png" style = "width:20%"></a>
    	<a href="/test/resources/img/1.png" data-lightbox="image-1" data-title="My caption"><img class="prodimg" src = "/test/resources/img/1.png" style = "width:20%"></a>	
    	</div>
 		<div id = "spectable">
